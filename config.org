...
#+end_src
* Visual Studio Code
I use Visual Studio Code for JavaScript development for it's excellent language support, but otherwise I do not buy much into the editor. Therefore I prefer doing things inside Emacs where appropriate. I use projectile and magit with Visual Studio Code.
#+begin_src elisp
